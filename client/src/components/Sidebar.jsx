...
const Sidebar = () => {
    ...
    return (
        <div className="flex-1 hidden flex-col justify-around items-center py-4 border-r-2 border-linegrey md:hidden lg:flex xl:flex 2xl:flex 2xl:border-l 2xl:border-linegrey">
            {genres.map(genre => (
